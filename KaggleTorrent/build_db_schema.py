...
def build_db_schema(sqlalchemy_engine):
      """
      Builds the schema for the KaggleTorrent database.

      N.B.: In order to use this function, the KaggleTorrent database
      must already be present in your DBMS.
      ...
      Table('UserAchievements', metadata,
            Column('Id', Integer(), primary_key=True),
      ...
      Table('KernelLanguages', metadata,
            Column('Id', Integer(), primary_key=True),
      ...
      Table('KernelVersionDatasetSources', metadata,
            Column('Id', Integer(), primary_key=True),
...
if __name__ == "__main__":
      ...
      build_db_schema(sqlalchemy_engine=e)
